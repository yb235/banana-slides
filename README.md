...
为了帮助开发者和用户更好地理解和使用 Banana Slides，我们提供了完整的技术文档：

### 快速导航

| 文档 | 说明 |
|-----|------|
| **[架构文档](docs/ARCHITECTURE.md)** | 系统架构、技术栈、数据流和核心组件详解 |
| **[后端文档](docs/BACKEND.md)** | 后端代码结构、模型、服务、控制器和工作流程 |
| **[前端文档](docs/FRONTEND.md)** | 前端组件、状态管理、页面和用户交互流程 |
| **[API文档](docs/API.md)** | 完整的 REST API 接口文档和使用示例 |
| **[部署文档](docs/DEPLOYMENT.md)** | Docker、手动部署、生产环境配置和故障排除 |
| **[文档总览](docs/README.md)** | 文档索引和快速入门指南 |
...
✅ **全面详细**：从架构到API，从前端到后端，覆盖所有技术细节

✅ **初学者友好**：清晰的图表、完整的代码示例和详细的说明

✅ **实用指南**：包含常见问题解决方案、最佳实践和性能优化建议
...
- [后端文档](docs/BACKEND.md) 或 [前端文档](docs/FRONTEND.md) - 了解代码结构
- [API文档](docs/API.md) - 了解接口规范
